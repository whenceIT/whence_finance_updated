...
@section('title')
    {{ trans_choice('general.edit',1) }} {{ trans_choice('general.deposit',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.add',1) }} {{ trans_choice('general.deposit',1) }}</h3>
        ...
        <form method="post" action="{{url('savings/deposit/'.$savings_transaction->id.'/update')}}" class="form-horizontal" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="date"
                               ...
                               value="{{$savings_transaction->date}}"
                               required id="date">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" name="amount"
                               class="form-control"
                               value="{{$savings_transaction->credit}}"
                               required id="amount">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="payment_type_id" class="form-control select2"
                            ...
                            @foreach(\App\Models\PaymentType::all() as $key)
                                <option value="{{$key->id}}" @if($savings_transaction->payment_detail->payment_type_id==$key->id) selected @endif>{{$key->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="account_number"
                                   class="form-control"
                                   value="{{$savings_transaction->payment_detail->account_number}}"
                                   id="account_number">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="cheque_number"
                                   class="form-control"
                                   value="{{$savings_transaction->payment_detail->cheque_number}}"
                                   id="cheque_number">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="routing_code"
                                   class="form-control"
                                   value="{{$savings_transaction->payment_detail->routing_code}}"
                                   id="routing_code">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="receipt_number"
                                   class="form-control"
                                   value="{{$savings_transaction->payment_detail->receipt_number}}"
                                   id="receipt_number">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="bank"
                                   class="form-control"
                                   value="{{$savings_transaction->payment_detail->bank}}"
                                   id="bank">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                                                     <textarea name="notes" class="form-control"
                                                               id="notes"
                                                               rows="3">{{$savings_transaction->notes}}</textarea>
                    </div>
                </div>
