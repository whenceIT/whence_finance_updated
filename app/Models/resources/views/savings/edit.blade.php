...
@section('content')
    <div class="box box-primary">
        ...
        <form method="post" action="{{url('loan/'.$loan->id.'/update')}}" class="form-horizontal"
                    ...
                    <div class="col-md-3">
                        <select name="currency_id" class="form-control select2" id="currency_id" disabled>
                            ...
                            @foreach(\App\Models\Currency::where('active',1)->get() as $key)
                                <option value="{{$key->id}}"
                                        @if($loan->currency_id==$key->id) selected @endif>{{$key->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <label for="decimals"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="number" name="repayment_frequency" class="form-control" min="0"
                               placeholder="" value="{{$loan->repayment_frequency}}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="interest_rate_type" class="form-control " id="interest_rate_type"
                                required>
                            <option value="month"
                                    @if($loan->interest_rate_type=="month") selected @endif>{{trans_choice('general.per',2)}} {{trans_choice('general.month',1)}}</option>
                            <option value="year"
                                    @if($loan->interest_rate_type=="year") selected @endif>{{trans_choice('general.per',2)}} {{trans_choice('general.year',1)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" name="grace_on_interest_payment" class="form-control" min="0"
                               value="{{$loan->grace_on_interest_payment}}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" name="grace_on_interest_charged" class="form-control" min="0"
                               value="{{$loan->grace_on_interest_charged}}"
                    ...
                    <div class="col-md-3">
                        <select name="interest_method" class="form-control " id="interest_method"
                                required>
                            <option value="flat"
                                    @if($loan->interest_method=="flat") selected @endif>{{trans_choice('general.flat',1)}}</option>
                            <option value="declining_balance"
                                    @if($loan->interest_method=="declining_balance") selected @endif>{{trans_choice('general.declining_balance',1)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="armotization_method" class="form-control " id="armotization_method"
                            ...
                            <option value="equal_installment"
                                    @if($loan->armotization_method=="equal_installment") selected @endif>{{trans_choice('general.equal_installment',1)}}</option>
                            <option value="equal_principal"
                                    @if($loan->armotization_method=="equal_principal") selected @endif>{{trans_choice('general.declining_balance',1)}}</option>
                        </select>
                    </div>
                    <label for="year_days"
                    ...
                    <div class="col-md-3">
                        <select name="year_days" class="form-control " id="year_days"
                                required>
                            <option value="actual"
                                    @if($loan->year_days=="actual") selected @endif>{{trans_choice('general.actual',1)}}</option>
                            <option value="360" @if($loan->year_days=="360") selected @endif>
                                360 {{trans_choice('general.day',2)}}</option>
                            <option value="364" @if($loan->year_days=="364") selected @endif>
                                364 {{trans_choice('general.day',2)}}</option>
                            <option value="365" @if($loan->year_days=="365") selected @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="month_days" class="form-control " id="month_days"
                                required>
                            <option value="actual"
                                    @if($loan->month_days=="actual") selected @endif>{{trans_choice('general.actual',1)}}</option>
                            <option value="30" @if($loan->month_days=="30") selected @endif>
                    ...
                    <div class="col-md-3">
                        <select name="loan_transaction_strategy" class="form-control " id="loan_transaction_strategy"
                            ...
                            <option value="penalty_fees_interest_principal"
                                    @if($loan->loan_transaction_strategy=="penalty_fees_interest_principal") selected @endif>{{trans_choice('general.penalty_fees_interest_principal',1)}}</option>
                            <option value="principal_interest_penalty_fees"
                                    @if($loan->loan_transaction_strategy=="principal_interest_penalty_fees") selected @endif>{{trans_choice('general.principal_interest_penalty_fees',1)}}</option>
                            <option value="interest_principal_penalty_fees"
                                    @if($loan->loan_transaction_strategy=="interest_principal_penalty_fees") selected @endif>{{trans_choice('general.interest_principal_penalty_fees',1)}}</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="lock_guarantee" class="form-control " id="lock_guarantee"
                                required>
                            <option value="1"
                                    @if($loan->lock_guarantee=="1") selected @endif>{{trans_choice('general.yes',1)}}</option>
                            <option value="0"
                                    @if($loan->lock_guarantee=="0") selected @endif>{{trans_choice('general.no',1)}}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        <select name="allow_additional_charges" class="form-control select2"
                            ...
                            <option value="1"
                                    @if($loan->allow_additional_charges=="1") selected @endif>{{trans_choice('general.yes',1)}}</option>
                            <option value="0"
                                    @if($loan->allow_additional_charges=="0") selected @endif>{{trans_choice('general.no',1)}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="charges_dropdown" class="form-control select2" id="charges_dropdown">
                            <option></option>
                            @foreach(\App\Models\Charge::where('currency_id', $loan->currency_id)->where('active', 1)->get() as $key)
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="accounting_rule" class="form-control select2"
                            ...
                            <option value="none"
                                    @if($loan->accounting_rule=="none") selected @endif>{{trans_choice('general.none',1)}}</option>
                            <option value="cash"
                                    @if($loan->accounting_rule=="cash") selected @endif>{{trans_choice('general.cash',1)}}</option>
                            <option value="accrual_periodic"
                                    @if($loan->accounting_rule=="accrual_periodic") selected @endif>{{trans_choice('general.accrual_periodic',1)}}</option>
                            <option value="accrual_upfront"
                                    @if($loan->accounting_rule=="accrual_upfront") selected @endif>{{trans_choice('general.accrual_upfront',1)}}</option>
                        </select>
                    </div>
                </div>
                <div id="accounting">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_fund_source_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_fund_source_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_loan_portfolio_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_loan_portfolio_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select name="gl_account_receivable_interest_id" class="form-control select2"
                                    ...
                                    @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                        <option value="{{$key->id}}"
                                                @if($loan->gl_account_receivable_interest_id==$key->id) selected @endif>{{$key->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                <select name="gl_account_receivable_fee_id" class="form-control select2"
                                    ...
                                    @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                        <option value="{{$key->id}}"
                                                @if($loan->gl_account_receivable_fee_id==$key->id) selected @endif>{{$key->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select name="gl_account_receivable_penalty_id" class="form-control select2"
                                    ...
                                    @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"asset")->get() as $key)
                                        <option value="{{$key->id}}"
                                                @if($loan->gl_account_receivable_penalty_id==$key->id) selected @endif>{{$key->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_loan_over_payments_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"liability")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_loan_over_payments_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_suspended_income_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"liability")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_suspended_income_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_income_interest_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"income")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_income_interest_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_income_fee_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"income")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_income_fee_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_income_penalty_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"income")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_income_penalty_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_income_recovery_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"income")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_income_recovery_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <select name="gl_account_loans_written_off_id" class="form-control select2"
                                ...
                                @foreach(\App\Models\GlAccount::where('active',1)->where('account_type',"expense")->get() as $key)
                                    <option value="{{$key->id}}"
                                            @if($loan->gl_account_loans_written_off_id==$key->id) selected @endif>{{$key->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
