...
@section('title')
    {{ trans_choice('general.asset',1) }} {{ trans_choice('general.type',2) }}
@endsection
@section('content')
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('assets.types.create'))
                    <a href="{{ url('asset/type/create') }}" class="btn btn-info btn-sm">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    @if(Sentinel::hasAccess('assets.types.update'))
                                        <li>
                                            <a href="{{ url('asset/type/'.$key->id.'/edit') }}"><i
                                                        class="fa fa-edit"></i>
                                    ...
                                    @if(Sentinel::hasAccess('assets.types.delete'))
                                        <li>
                                            <a href="{{ url('asset/type/'.$key->id.'/delete') }}"
                                               class="delete"><i
                                                        class="fa fa-trash"></i>
