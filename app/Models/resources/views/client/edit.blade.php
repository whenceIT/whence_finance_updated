...
@section('content')
    ...
    <div class="form-group">
        ...
        <label for="working_position" class="control-label col-md-2">Occupation</label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label for="salary" class="control-label col-md-2">Net Pay</label>
        <div class="col-md-3">
...
@elseif($client->client_type == 'business')
    <div class="form-group">
        <label for="salary" class="control-label col-md-2">Monthly Turnover</label>
        <div class="col-md-3">
            <input type="text" name="salary" class="form-control"
                   value="{{$client->monthly_turnover}}"
                   id="salary">
        </div>
    </div>

    <div class="form-group">
    <label for="key_contact_name" class="control-label col-md-2">Key Contact Name</label>
    <div class="col-md-3">
        <input type="text" name="key_contact_name" class="form-control"
               value="{{ $client->key_contact_person ?? '' }}"
               id="key_contact_name">
    </div>

    <label for="key_contact_phone" class="control-label col-md-2">Key Contact Phone</label>
    <div class="col-md-3">
        <input type="text" name="key_contact_phone" class="form-control"
               value="{{ $client->key_contact_phone ?? '' }}"
