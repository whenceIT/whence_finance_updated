<aside class="main-sidebar" style="color: #ffffff">
    ...
    <section class="sidebar" style="color:#ffffff;">
        ...
        <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <ul class="treeview-menu">
                        @if(Sentinel::hasAccess('clients.view'))
                            <li><a href="{{ url('client/data') }}"><i
                                    ...
                                    <span class="pull-right-container">
                                        <span class="label label-info pull-right">{{ \App\Models\Client::count() }}</span>
                                    </span>
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('clients.my_clients'))
                            <li><a href="{{ url('client/my_clients') }}"><i
                                    ...
                                    <span class="pull-right-container">
                                    <?php $staff_id = Sentinel::getUser()->id; ?>
                        ...
                        @if(Sentinel::hasAccess('clients.branch_clients'))
                            <li><a href="{{ url('client/branch_clients') }}"><i
                                    ...
                                    <span class="pull-right-container">
                                    <?php $office_id = Sentinel::getUser()->office_id; ?>
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if(Sentinel::hasAccess('loans.my_loans'))
                            <li><a href="{{ url('loan/my_loans') }}"><i
                                    ...
                                    <span class="pull-right-container">
                                    <?php $loan_officer_id = Sentinel::getUser()->id; ?>
                        ...
                        @if(Sentinel::hasAccess('loans.transactions.create'))
                            <li class="@if(Request::is('loan/repayment/bulk') || Request::is('loan/repayment/bulk/*')) active @endif">
                                <a href="{{ url('loan/repayment/bulk') }}">
                                    <i class="fa fa-circle-o"></i> Bulk Repayments Upload
                                </a>
                            </li>
                        @endif
                        ...
                        @endif
                        @if(Sentinel::hasAccess('loans.create'))
                            <li><a href="{{ url('loan/termination/drafts') }}"><i
                                            class="fa fa-circle-o"></i> Terminations
                                </a></li>
                        @endif
                    </ul>
                </li>
            ...
            {{-- RECOVERIES MODULE                                        --}}
            {{-- ====================================================== --}}
            @if(Sentinel::hasAccess('recoveries'))
                <li class="treeview @if(Request::is('recovery/*')) active @endif">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @endif
                        @if(Sentinel::hasAccess('recoveries.specialists.view'))
                        ...
                        @endif
                        @if(Sentinel::hasAccess('recoveries.reports'))
