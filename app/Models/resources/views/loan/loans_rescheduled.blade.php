...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"> {{ trans_choice('general.loan',2) }} {{ trans_choice('general.rescheduled',1) }}</h3>
        ...
        <div class="box-body table-responsive">
            <table class="table  table-bordered table-hover table-striped" id="data-table">
                ...
                <tr>
                    ...
                    <th>{{ trans_choice('general.rescheduled',1) }} {{ trans_choice('general.on',1) }}</th>
