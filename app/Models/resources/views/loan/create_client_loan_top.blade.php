...
<style>
    ...
    <div class="box box-primary">
       ...
       value="{{ session('loan_defaults.expected_disbursement_date') ?? old('disbursement_date') }}">
...
<input type="hidden" name="created_date" id="created_date" value="{{ date('Y-m-d') }}">
                ...
                <input type="hidden" name="previous_loan_id" value="{{ session('previous_loan_id') }}">
<input type="hidden" name="disbursed_cash_amount" value="{{ session('top_up_amount') }}">
       ...
       value="{{ session('loan_defaults.principal') ?? old('principal') }}" id="principal">
                    ...
                    value="{{ session('loan_defaults.loan_term') ?? old('loan_term') }}">
                    </div>
                    <div class="col-md-2">
    ...
    <option value="years" disabled @if($loan_product->repayment_frequency_type=="years") selected @endif>{{trans_choice('general.year',2)}}</option>
                ...
                <div class="form-group" id="interest_rate_div">
                    ...
                    value="{{ session('loan_defaults.interest_rate') ?? old('interest_rate') }}">
                    </div>
    ...
    <div class="col-md-2">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="expected_disbursement_date" class="form-control date-picker"
                               placeholder=""
                               id="expected_disbursement_date"  value="{{date("Y-m-d")}}" readonly>
                    </div>
       ...
       value="{{ session('loan_defaults.first_repayment_date') ?? date('Y-m-d', strtotime('+1 month')) }}"
       required>
