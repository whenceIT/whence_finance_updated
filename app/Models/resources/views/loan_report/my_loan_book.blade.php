                    ...
                    <div class="col-md-4">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="{{url('report/loan_report/loan_book/pdf?end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
            ...
            <div class="panel-body table-responsive ">
                ...
                <table class="table table-condensed table-hover " style="font-size: 12px">
                    ...
                    @foreach($data as $key)
                        ...
                        $total_clients = \App\Models\Loan::where('office_id', $key->id)->count();
                    ...
                    <tr style="height: 20pt">
                        <td colspan="40" valign="middle" class="style-17"></td>
