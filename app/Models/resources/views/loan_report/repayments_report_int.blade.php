...
@section('title')
    {{trans_choice('general.repayment',2)}} {{trans_choice('general.report',1)}} Interest
@endsection
@section('content')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="{{url('report/loan_report/repayments_report_interest/pdf?start_date='.$start_date.'&end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
                                                class="icon-file-pdf"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.pdf',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/repayments_report_interest/excel?start_date='.$start_date.'&end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
                                                class="icon-file-excel"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.excel',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/repayments_report_interest/csv?start_date='.$start_date.'&end_date='.$end_date.'&office_id='.$office_id)}}"
                                       target="_blank"><i
                ...
                <table class="table  table-condensed table-hover">
                    ...
                    <tr style="height: 25pt">
                        <td colspan="11" valign="middle"
                            class="style-1">  {{trans_choice('general.repayment',2)}} {{trans_choice('general.report',1)}} Interest</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <b>{{number_format($total_interest,$decimals)}}</b>
                        </td>
                        <td colspan="3"></td>
                    </tr>
                    </tfoot>
