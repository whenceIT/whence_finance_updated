    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr>
                    <td>
                        <a href="{{url('report/loan_report/closed_loans_report')}}">{{trans_choice('general.closed',2)}} {{trans_choice('general.loan',2)}} {{trans_choice('general.report',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.repayments_report_description',1)}}
                    </td>
                    <td><a href="{{url('report/loan_report/closed_loans_report')}}"><i class="icon-search4"></i> </a>
                    </td>
                </tr>
     ...
     <tr>
                ...
                <tr>
                    <td>
                        <a href="{{url('report/loan_report/consage_analysis_principle')}}"> Consolidated {{trans_choice('general.age',1)}} {{trans_choice('general.analysis',1)}} Principle Balances</a>
                    </td>
                    <td>
                        {{trans_choice('general.age_analysis_report_description',1)}}
                    </td>
