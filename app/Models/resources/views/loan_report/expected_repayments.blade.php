                ...
                <table cellspacing="0" cellpadding="0" class="style-0">
                    ...
                    <tr style="height: 7pt">
                        <td colspan="4" valign="middle"
                            class="style-6">{{trans_choice('general.cash_flow',1)}} {{trans_choice('general.per',1)}} {{trans_choice('general.office',1)}}</td>
                    ...
                    @foreach($data as $key)
                        <?php
                        $loans = \App\Models\Loan::where('status', 'disbursed')->where('office_id', $key->id)->with(['repayment_schedules' => function ($query) use ($start_date, $end_date) {
