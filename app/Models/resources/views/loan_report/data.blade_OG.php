...
@section('content')
 ...
 @if(Sentinel::hasAccess('reports.my_collection_sheet'))
                <tr>
                    <td>
                        <a href="{{url('report/loan_report/my_collection_sheet')}}">{{trans_choice('general.my',1)}} {{trans_choice('general.collection',2)}} {{trans_choice('general.sheet',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.collection_sheet_report_description',1)}}
                    </td>
...
@endif
                ...
                <tr>
                    <td>
                        <a href="{{url('report/loan_report/my_loan_book')}}">{{trans_choice('general.my',1)}} {{trans_choice('general.loan',1)}} {{trans_choice('general.book',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.age_analysis_report_description',1)}}
                    </td>
                    <td><a href="{{url('report/loan_report/my_loan_book')}}"><i class="icon-search4"></i> </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <a href="{{url('report/loan_report/age_analysis')}}">{{trans_choice('general.age',1)}} {{trans_choice('general.analysis',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.age_analysis_report_description',1)}}
                    </td>
