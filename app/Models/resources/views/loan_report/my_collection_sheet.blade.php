...
@section('title')
{{trans_choice('general.my',1)}} {{trans_choice('general.collection',1)}} {{trans_choice('general.sheet',1)}}
@endsection
@section('content')
    <style type="text/css">
        .style-0 {
    ...
    <div class="box box-primary">
        ...
        <div class="box-body hidden-print">
            <form method="post" action="{{Request::url()}}" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="hidden" for="office_id"
                           class="control-label col-md-2">{{trans_choice('general.office',1)}} </label>
                    <div class="col-md-3">
                        <select name="office_id" class="hidden" class="form-control select2" id="office_id" required>
                            <option value="0"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select disabled name="loan_officer_id" class="form-control select2" id="loan_officer_id" required>
                ...
                <table class="table  table-condensed table-hover">
                    ...
                    <tr style="height: 25pt">
                        <td colspan="12" valign="middle"
                            class="style-1"> {{trans_choice('general.my',1)}} {{trans_choice('general.collection',1)}}  {{trans_choice('general.sheet',1)}}</td>
                    </tr>
