    ...
    <div class="box box-primary">
       ...
       <div>
        <hr>
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Consolidated {{trans_choice('general.financial',1)}} {{trans_choice('general.report',2)}}</h3>
        ...
        <div class="box-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr>
                    <td>
                        <a href="{{url('report/financial_report/balance_sheet_conso')}}">{{trans_choice('general.balance',1)}} {{trans_choice('general.sheet',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.balance',1)}} {{trans_choice('general.sheet',1)}}
                    </td>
                ...
                <tr>
                    <td>
                        <a href="{{url('report/financial_report/trial_balance_conso')}}">{{trans_choice('general.trial_balance',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.trial_balance',1)}}
                    </td>
                ...
                <tr>
                    <td>
                        <a href="{{url('report/financial_report/income_statement_conso')}}">{{trans_choice('general.income',1)}} {{trans_choice('general.statement',1)}}</a>
                    </td>
                    <td>
                        {{trans_choice('general.income_statement_description',1)}}
                    </td>
