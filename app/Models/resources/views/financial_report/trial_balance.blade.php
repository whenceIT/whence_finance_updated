...
@section('content')
    ...
    <!-- Checkbox to exclude zero-balance accounts -->
    <div class="form-group">
        <label for="exclude_zero_balances" class="control-label col-md-2">Exclude Zero Balances</label>
        <div class="col-md-3">
            <input type="checkbox" name="exclude_zero_balances" id="exclude_zero_balances" value="1"
                   @if(!empty(request('exclude_zero_balances'))) checked @endif>
        </div>
    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <a href="{{url('report/financial_report/trial_balance/pdf?end_date='.$end_date.'&office_id='.$office_id)}}"
                           target="_blank"><i class="icon-file-pdf"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.pdf',1)}}
                        </a></li>
                    <li>
                        <a href="{{url('report/financial_report/trial_balance/excel?end_date='.$end_date.'&office_id='.$office_id)}}"
                           target="_blank"><i class="icon-file-excel"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.excel',1)}}
                        </a></li>
                    <li>
                        <a href="{{url('report/financial_report/trial_balance/csv?end_date='.$end_date.'&office_id='.$office_id)}}"
                           target="_blank"><i class="icon-download"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.csv',1)}}
                        </a></li>
                </ul>
            </div>
        </div>
...
<th  align="right" style="text-align: right;" width="100"><i> Month to date</i></th>
<th  align="right" style="text-align: right;" width="100"></th>
<th  align="right" style="text-align: right;" width="100"><i>Year to date</i> </th>
...
@foreach($data as $key)
    ...
    })->where('date','<=',$end_date)->where('year',
    $d[0])->where('transaction_type','!=','year_end')->where('month',
    $d[1])->get();
    ...
    $total_xdr = $total_xdr + $xdr;
    $total_xcr = $total_xcr + $xcr;
