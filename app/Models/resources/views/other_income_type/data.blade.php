        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('other_income.types.create'))
                    <a href="{{ url('other_income/type/create') }}" class="btn btn-info btn-sm">
        ...
        <div class="box-body table-responsive">
            <table class="table  table-bordered table-hover table-striped" id="data-table">
                ...
                <tr>
                    ...
                    <th>{{ trans_choice('general.income',1) }} {{ trans_choice('general.account',1) }}</th>
                ...
                @foreach($data as $key)
                    <tr>
                        ...
                        <td>
                            @if(!empty($key->gl_account_income))
                                {{$key->gl_account_income->name}}
                            @endif
                        </td>
                        <td>{{ $key->notes }}</td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    @if(Sentinel::hasAccess('other_income.types.update'))
                                        <li>
                                            <a href="{{ url('other_income/type/'.$key->id.'/edit') }}"><i
                                                        class="fa fa-edit"></i>
                                    ...
                                    @if(Sentinel::hasAccess('other_income.types.delete'))
                                        <li>
                                            <a href="{{ url('other_income/type/'.$key->id.'/delete') }}"
                                               class="delete"><i
                                                        class="fa fa-trash"></i>
