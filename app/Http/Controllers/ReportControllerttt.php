...
class ReportController extends Controller
{
    ...
    public function my_collection_sheet(Request $request)
    {
        if (!Sentinel::hasAccess('reports.collection_sheet')) {
            Flash::warning("Permission Denied");
            return redirect()->back();
        ...
        return view('loan_report.my_collection_sheet',
            compact('start_date',
                'end_date', 'data', 'office_id', 'loan_officer_id'));
    }
    ...
    public function age_analysis(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            Flash::warning("Pleas set end date");
            return redirect()->back();

                /**
                 * work around for view not found
                 */
    ...
    public function my_loan_book(Request $request)
    {
        if (!Sentinel::hasAccess('reports.loan_book')) {
            Flash::warning("Permission Denied");
            return redirect()->back();
        ...
        return view('loan_report.my_loan_book',
            compact('start_date',
                'end_date', 'data', 'office_id', 'loan_product_id', 'loan_officer_id', 'status'));
    }
    ...
    {
        if (!Sentinel::hasAccess('reports.ledger_statement_reports')) {
            Flash::warning("Permission Denied");
            return redirect()->back();
        }
        $start_date = $request->start_date;
        ...
        //workaround for undefined varible data
        $data = $data ? $data : [];
