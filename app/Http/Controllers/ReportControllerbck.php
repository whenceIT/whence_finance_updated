...
public function GetCustomerStatmentReport(Request $request , Loan $loan)
    {
        ...
        return view('loan_report.customer_statement',
            compact('start_date',
                'end_date', 'data','current_balance','office_id', 'loan_id','loan'));
    }
...
public function repayments_report_details_csv(Request $request)
{
    ...
    public function full_repayments_report_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            return Excel::download(new ExportReport("loan_report.full_payments_excel", $data), trans_choice('general.repayment', 2) . ' ' . trans_choice('general.report',
                    1) . '.xlsx');
        }
    ...
    public function part_repayments_report_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            return Excel::download(new ExportReport("loan_report.part_payments_excel", $data), trans_choice('general.repayment', 2) . ' ' . trans_choice('general.report',
            1) . '.xlsx');
   ...
   public function expected_collections_report_pdf(Request $request){
    ...
    public function reloans_report_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            return Excel::download(new ExportReport("loan_report.reloans_excel", $data), trans_choice('general.repayment', 2) . ' ' . trans_choice('general.report',
            1) . '.xlsx');
    ...
    public function new_loans_report_pdf(Request $request)
    {
        ...
        public function new_loans_report_excel(Request $request)
        {
            ...
            $office_id = $request->office_id;
                    ...
                    return Excel::download(new ExportReport("loan_report.new_loans_excel", $data), trans_choice('general.repayment', 2) . ' ' . trans_choice('general.report',
                    1) . '.xlsx');
