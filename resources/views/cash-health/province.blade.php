...
">
    ...
    @php
        ...
        $financials = $provinceHealth['financials'] ?? [];
        $scores = $provinceHealth['scores'] ?? [];
    ...
    ">
        ...
        <div>
            ...
            <div style="
                ...
                font-size:14px;
            ">
                {{ $provinceHealth['province_name'] ?? 'Province' }}
            </div>
        ...
        ">
            ...
            <form
                method="GET"
                action="{{ url('cash_health/province/' . ($provinceHealth['province_id'] ?? request()->route('province'))) }}"
                style="margin:0;"
            >
    ...
    ">
        ...
        @if(!empty($provinceHealth['reason']))
    ...
    ">
        ...
        ">
            ...
            @foreach($provinceMetrics as $label => $value)
    ...
    ">
        ...
        ">
            ...
            @foreach(($provinceHealth['reserve_breakdown'] ?? []) as $label => $value)
