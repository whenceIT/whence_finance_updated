...
@section('title')
    Add Bank Account Expense
@endsection

@section('content')
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Add Bank Account Expense</h3>
    </div>

    <form method="POST" action="{{ route('bank_account_expenses.store') }}" class="form-horizontal">
        {{ csrf_field() }}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="transaction_date" class="form-control date-picker" value="{{ date('Y-m-d') }}" required>
                </div>
            </div>
