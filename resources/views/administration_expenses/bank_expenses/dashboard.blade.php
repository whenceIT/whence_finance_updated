...
@section('title')
    Bank Account Expenses Dashboard
@endsection

@section('content')
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Bank Account Expenses Dashboard</h3>
        <div class="box-tools pull-right">
            <a href="{{ route('bank_account_expenses.index') }}" class="btn btn-info btn-sm">Back to List</a>
        </div>
    </div>
    ...
    <div class="box-body">
        ...
        <h4>Expenses by Bank Account</h4>
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
