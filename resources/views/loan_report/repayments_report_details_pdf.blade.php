...
<div class="col-md-12">
<div class="white-box">
	                            <h3>@if(!empty($key->office)){{$key->office->name}} @endif - Repayment Reports<span class="pull-right"></span></h3>
	                            <hr>
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
        ...
        @endif
												<p class="text-muted m-l-6">
                                                 <b>@if(!empty($key->office)){{$key->office->name}} @endif</b><br> 
                                                 from: <b>{{$start_date}} to {{$end_date}}</b><br> 
                                                 <br>
                                                 </p>                                        
											</address>
										</div>
	                        <div class="white-box">
	                            <h3>Full Repayments <span class="pull-right"> </span></h3>
	                            <hr>
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
                ...
                <div class="col-md-12">
	                        <div class="white-box">
	                            <h3>Part Repayments <span class="pull-right"> </span></h3>
	                            <hr>
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
                ...
                <div class="col-md-12">
	                        <div class="white-box">
	                            <h3>Reloans <span class="pull-right"></span></h3>
	                            <hr>
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
                ...
                <div class="col-md-12">
	                        <div class="white-box">
	                            <h3>New Loans <span class="pull-right"></span></h3>
	                            <hr>
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
