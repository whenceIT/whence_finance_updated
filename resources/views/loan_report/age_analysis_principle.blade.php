...
@section('title')
{{trans_choice('general.age',1)}} Analysis by {{trans_choice('general.principal',1)}} {{trans_choice('general.balance',2)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">
            {{trans_choice('general.age',1)}} Analysis {{trans_choice('general.report',1)}} by {{trans_choice('general.principal',1)}} {{trans_choice('general.balance',2)}}
                @if(!empty($end_date))
                    as at: <b> {{$end_date}}</b>
                @endif
            </h3>
