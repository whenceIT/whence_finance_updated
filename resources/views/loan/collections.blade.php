...
<p style="font-weight: bold;">TOTAL: K{{$todayTotal}}</p>
</div>
...
<p style="font-weight: bold;">TOTAL: K{{$thisWeekTotal}}</p>
</div>
...
if($Loan->first_repayment_date >= $todaysDate && $Loan->first_repayment_date <= $thisMonthDate){
    $thisMonthTotal = $thisMonthTotal + $OutIn;
}
...
<p style="font-weight: bold;">TOTAL: K{{$thisMonthTotal}}</p>
</div>
