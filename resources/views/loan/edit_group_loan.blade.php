...
@section('content')
    <div class="box box-primary">
        ...
        <form method="post" action="{{url('loan/group_loan/'.$loan->id.'/update')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="number" name="client[{{$key->client_id}}]" class="form-control client_amount"
                                   placeholder=""
                                   value="@if(!empty(\App\Models\GroupLoanAllocation::where('loan_id',$loan->id)->where('client_id',$key->client_id)->first())){{\App\Models\GroupLoanAllocation::where('loan_id',$loan->id)->where('client_id',$key->client_id)->first()->amount}}@endif"
                                   required id="client_{{$key->client_id}}" onblur="update_client_total(this)">
                        </div>
                    </div>
                @endforeach
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" name="client_total_amount" class="form-control"
                               required id="client_total_amount" min="{{$loan->applied_amount}}"
                               max="{{$loan->applied_amount}}" value="{{$loan->applied_amount}}" readonly>
                    </div>
                </div>
