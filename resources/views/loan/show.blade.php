...
@section('content')
    ...
    <!-- Ledger Blocker Modal (non-dismissible) -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning" role="alert" style="margin-bottom:0;">
                        <p class="mb-2">If you recorded the payment under expenses, please provide the <strong>reference_numbers</strong> recorded in the expense to IT.</p>
