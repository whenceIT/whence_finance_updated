                <div class="tab-pane" id="resolved_by_me">
                    <div class="view-toggle mb-3">
                        <button id="table-view-btn-resolved" class="btn btn-secondary">Table View</button>
                        <button id="grid-view-btn-resolved" class="btn btn-primary">Grid View</button>
                    </div>
                    @if($assignedClosedTickets->count())
                    <div id="table-view-resolved" style="display:none;">
                                    ...
                                    <div class="ticket-card-body">
                                        ...
                                        <div class="ticket-info">
                                            ...
                                            <div class="ticket-info-row">
                                                ...
                                                <span class="ticket-info-value">{{ optional($ticket->createdBy)->first_name ?? optional($ticket->createdBy)->name ?? '—' }}</span>
                                            </div>
                                            <div class="ticket-info-row">
                    ...
                    $(document).ready(function(){
                        $('#table-view-btn-resolved').click(function(){
                            $('#table-view-resolved').show();
                            $('#grid-view-resolved').hide();
                            $(this).addClass('btn-primary').removeClass('btn-secondary');
                            $('#grid-view-btn-resolved').addClass('btn-secondary').removeClass('btn-primary');
                        });
                        $('#grid-view-btn-resolved').click(function(){
                            $('#grid-view-resolved').show();
                            $('#table-view-resolved').hide();
                            $(this).addClass('btn-primary').removeClass('btn-secondary');
                            $('#table-view-btn-resolved').addClass('btn-secondary').removeClass('btn-primary');
                        });
