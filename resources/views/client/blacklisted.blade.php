...
@section('title')
    {{ trans_choice('general.client',2) }} {{ trans_choice('general.blacklisted',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.client',2) }} {{ trans_choice('general.blacklisted',1) }}</h3>

            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('clients.blacklist.create'))
                    <a href="{{ url('client/create_blacklist') }}" class="btn btn-info btn-sm">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    @if(Sentinel::hasAccess('clients.blacklist.update'))
                                        <li>
                                            <a href="{{ url('client/'.$key->id.'/remove_blacklist') }}"><i
                                                        class="fa fa-edit"></i>
