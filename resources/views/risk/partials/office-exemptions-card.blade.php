...
$exemptions = [
    [
        ...
        'description' => $officeSettings['admin'] 
            ...
            : 'Excluded blocking your account from making payment to Administration Department fee deposit',
    ...
    [
        ...
        'description' => $officeSettings['building'] 
            ...
            : 'Excluded blocking your account from making payment to Building & Infrastructure fee deposits',
    ...
    [
        ...
        'description' => $officeSettings['statutory'] 
            ...
            : 'Excluded blocking your account from making payment to Statutory payments deposits',
    ...
    [
        ...
        'description' => $officeSettings['set_up_debt'] 
            ...
            : 'Excluded blocking your account from making payment towards setup cost debt',
...
@if(!empty($exemptions) && collect($exemptions)->contains('enabled', true)) 
