...
<style>
    ...
    <!-- Policy of the Day - Modern Floating Card -->
    @php
    ...
    <script>
        // Auto-hide Policy of the Day after 10 seconds
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Add pulse animation for new policy
            const container = document.getElementById('policyOfTheDay');
            if (container) {
        ...
        // Show policy when hovering on the right edge of screen
        let edgeHoverTimeout;
        document.addEventListener('mousemove', function(e) {
            const container = document.getElementById('policyOfTheDay');

            // If policy is hidden and mouse is near right edge
