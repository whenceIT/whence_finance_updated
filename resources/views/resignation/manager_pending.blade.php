...
@section('title', 'Pending Resignations - Manager')

@section('content')
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Pending Resignations For Approval</h3>
    </div>
    <div class="box-body">
...
$('.approve-btn, .decline-btn').on('click', function() {
    ...
    $('#approvalForm').attr('action', '{{ url("resignation/manager/approve") }}/' + id + '?action=' + action);
