                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                        @if(Sentinel::hasAccess('offices.view'))
                                            <li class="hidden">
                                                <a href="{{ url('office/' . $key->id . '/show') }}"><i class="fa fa-search"></i>
                                                    {{ trans_choice('general.detail', 2) }}</a>
                                            </li>
                                        @endif
                                        @if(Sentinel::hasAccess('offices.update'))
                                            <li>
                                                <a href="{{ url('office/' . $key->id . '/edit') }}"><i class="fa fa-edit"></i>
                                                    {{ trans('general.edit') }}</a>
                                            </li>
                                        @endif
                                        @if(Sentinel::hasAccess('offices.delete'))
                                            <li>
                                                <a href="{{ url('office/' . $key->id . '/delete') }}" class="delete"><i
                                                        class="fa fa-trash"></i>
