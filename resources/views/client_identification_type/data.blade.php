...
@section('title')
    {{ trans_choice('general.identification',1) }} {{ trans_choice('general.type',2) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.identification',1) }} {{ trans_choice('general.type',2) }}</h3>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    @if(Sentinel::hasAccess('products.client_identification_types.update'))
                                        <li>
                                            <a href="{{ url('client_identification_type/'.$key->id.'/edit') }}"><i
                                                        class="fa fa-edit"></i>
                                    ...
                                    @if(Sentinel::hasAccess('products.client_identification_types.delete'))
                                        <li>
                                            <a href="{{ url('client_identification_type/'.$key->id.'/delete') }}"
                                               class="delete"><i
                                                        class="fa fa-trash"></i>
