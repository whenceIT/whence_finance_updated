...
@section('content')
    <div class="box box-primary">
        ...
        <form method="post" action="{{url('client_identification_type/'.$client_identification_type->id.'/update')}}" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="name" class="form-control"
                               value="{{$client_identification_type->name}}"
                               required id="name">
                    </div>
                </div>
            </div>
