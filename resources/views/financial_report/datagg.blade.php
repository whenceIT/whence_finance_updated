    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr class="hidden">
                    <td>
                        <a href="{{url('report/financial_report/ledger_report')}}">{{trans_choice('general.general',1)}} {{trans_choice('general.ledger',1)}} {{trans_choice('general.report',1)}}</a>
                    </td>
                    <td>
                        Report shows Ledger
                    </td>
                    <td><a href="{{url('report/financial_report/ledger_report')}}"><i class="icon-search4"></i> </a>
                    </td>
                </tr>
