        ...
        <div class="box box-primary">
                ...
                <table cellspacing="0" cellpadding="0" class="style-0">
                    <tbody>
                        <tr style="height: 33pt">
                            <td colspan="18" valign="middle" class="style-1"> {{trans_choice('general.balance', 1)}}
                                {{trans_choice('general.sheet', 1)}}</td>
                        </tr>
                        <tr style="height: 6pt">
                            <td colspan="16"></td>
                        </tr>
                        <tr style="height: 16pt">
                            ...
                            <td colspan="9" valign="middle" class="style-4">{{trans_choice('general.as', 1)}}
                                {{trans_choice('general.at', 1)}} {{$end_date}}</td>
                        </tr>
            ...
            $ototal_equity = 0;
                        ...
                        <tr style="height: 4pt">
                            ...
                            <td colspan="5" valign="middle" class="style-14">{{ number_format($total_assets, 2) }}</td>
                            <td colspan="9" valign="middle" class="style-14">{{ number_format($ototal_assets, 2) }}</td>
                        </tr>
                        ...
                        <tr style="height: 20pt">
                            ...
                            <td colspan="11" valign="middle" class="style-13">{{trans_choice('general.total', 1)}}
                        ...
                        <tr style="height: 18pt">
                            <td colspan="11" valign="middle" class="style-13">{{trans_choice('general.net', 1)}}
                                {{trans_choice('general.income', 2)}} :
                            </td>
                            <td colspan="5" valign="middle" class="style-14">
                                {{ number_format($total_liabilities - $total_liabilities, 2) }}</td>
                            <td colspan="9" valign="middle" class="style-14">
                                {{ number_format($ototal_liabilities - $ototal_liabilities, 2) }}</td>
                        </tr>
                        <tr style="height: 0pt">
                        ...
                        <tr style="height: 15pt">
                            ...
                            <td colspan="3" valign="middle" class="style-3">
                                {{trans_choice('general.current', 1)}} {{trans_choice('general.year', 1)}}
                                {{trans_choice('general.profit', 2)}}
                            </td>
            ...
            $opening_date = $office ? $office->opening_date : ($start_date ?? '2000-01-01');
            $total_expenses = 0;
            $ototal_expenses = 0;
            $total_income = 0;
            $ototal_income = 0;
            ...
            $ototal_equity = $ototal_equity + $ocurrent_year_profits;
                        ...
                        <tr style="height: 18pt">
                            <td align="right" colspan="11" valign="middle" class="style-13">{{trans_choice('general.total', 1)}}
                                {{trans_choice('general.liability', 2)}} {{trans_choice('general.and', 2)}}
                                {{trans_choice('general.equity', 2)}}
                                :
                            </td>
                            <td align="right" colspan="5" valign="middle" class="style-14">
                                {{ number_format($total_equity + $total_liabilities, 2) }}</td>
                            <td align="right" colspan="9" valign="middle" class="style-14">
                                {{ number_format($ototal_equity + $ototal_liabilities, 2) }}</td>
                        </tr>
                        </tr>
                    </tbody>
                </table>
