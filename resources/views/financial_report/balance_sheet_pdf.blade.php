    ...
    @if(!empty($end_date))
        <table cellspacing="0" cellpadding="0" class="style-0">
            <tbody>
                <tr style="height: 33pt">
                    <td colspan="16" valign="middle" class="style-1"> {{trans_choice('general.balance', 1)}}
        ...
        $total_equity = $total_equity + $current_year_profits;
                ...
                <tr style="height: 18pt">
                    ...
                    <td colspan="5" valign="middle" class="style-14">{{ number_format($total_equity + $total_liabilities, 2) }}
                    </td>
                </tr>
            </tbody>
        </table>
