        ...
        <div id="wizardContent" style="padding: 0; background: white; min-height: 480px;">
            ...
            <div id="step2" class="wizard-step" style="display: none;">
                ...
                <div class="wizard-content-flex"
                    style="display: flex; flex-direction: row; padding: 40px; gap: 40px; align-items: center;">
                    <div style="flex: 1;">
                        ...
                        <div id="audioStatus"
                            style="margin-top: 20px; font-size: 14px; color: #000041; display: none; align-items: center; gap: 10px;">
                            <i class="fa fa-volume-up"></i> <span>Audio introduction playing... The Next button will
                                appear once the audio finishes.</span>
                        </div>
                        <div id="nextHintStep2" style="margin-top: 10px; font-size: 13px; color: #666; display: none;">
                            <i class="fa fa-info-circle"></i> The Next button will appear once the audio finishes
                            playing.
                        </div>
                    </div>
            ...
            <div id="step3" class="wizard-step" style="display: none;">
                ...
                <div class="wizard-content-flex"
                    style="display: flex; flex-direction: row; padding: 40px; gap: 40px; align-items: flex-start;">
                    <div style="flex: 1.2;">
                        <h2 class="animate-slide-up delay-1"
            ...
            <div id="step6" class="wizard-step" style="display: none;">
                ...
                <div class="wizard-content-flex"
                    style="display: flex; flex-direction: row; padding: 35px; gap: 35px; align-items: flex-start;">
                    <div style="flex: 1.4;">
                        <h2 class="animate-slide-up delay-1"
                        ...
                        <div class="animate-slide-up delay-2"
                            ...
                            <ul
                                ...
                                <li style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;"><i
                                        class="fa fa-clock" style="color: #1976d2;"></i> Report to work on time
                                    (08:00hrs)
                                </li>
                                <li style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;"><i
                                    ...
                                    environment</li>
                                <li style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;"><i
                                        class="fa fa-briefcase" style="color: #1976d2;"></i> Keep your workstation neat
                                    and
                                    organized</li>
                                <li style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;"><i
                                        class="fa fa-comments" style="color: #1976d2;"></i> Use respectful language at
                                    all
                                    times</li>
                                <li style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;"><i
                                        class="fa fa-phone-slash" style="color: #1976d2;"></i> Take personal or
                                    sensitive
                                    calls privately</li>
                                <li style="margin-bottom: 0; display: flex; align-items: center; gap: 10px;"><i
                                        class="fa fa-user-tie" style="color: #1976d2;"></i> Demonstrate professionalism
                                    in
                                    all interactions</li>
                            </ul>
                        </div>
            ...
            <div id="step9" class="wizard-step" style="display: none;">
                <div style="padding: 50px 40px; text-align: center;">
                    ...
                    <div
                        ...
                        <table
                            style="color: #333; margin-bottom: 0; line-height: 1.8; font-size: 15px; width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="padding: 5px 10px;"><input type="checkbox" disabled
                            ...
                            <tr>
                                <td style="padding: 5px 10px;"><input type="checkbox" disabled
                                        style="margin-right: 10px;"></td>
                                <td style="padding: 5px 10px;">Complete training on Cash Handling in the Loan Management
                                    System.</td>
                            </tr>
                            <tr>
                                <td style="padding: 5px 10px;"><input type="checkbox" disabled
