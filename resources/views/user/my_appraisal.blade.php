  ...
  <div>
    <div class="header">
      <div class="headerContainer">
        ...
        <p style="font-weight: bold; font-size: 16px; text-decoration: underline;">{{$form->form_name}}
        <p>
      </div>
    </div>
    ...
    @if(session('message'))
      <div class="main">
        <div class="alert alert-success">
          ...
          Your Appraisal has been successfully submitted
        </div>
      </div>
    @endif
    ...
    <div class="main">
      ...
      <div class="infobox">
        ...
        <form id="regForm" method="post" action="{{url('user/' . $form->id . '/submit_appraisal')}}"
              ...
              @foreach($questions as $question)
                @if($question->section_id == $section->id)
                  ...
                  @if($question->unit == 'p_r')
                    @foreach($peers as $peer)
                      ...
                      ?>
                                  ...
                                  <select name="{{$peer->id}}{{$question->id}}" id="{{$peer->id}}{{$question->id}}" required>
                                    <option></option>
                  ...
                  @elseif($question->unit == 'sb_r')
                    @foreach($managers as $manager)
                      ...
                      ?>
                                  ...
                                  <select name="{{$manager->id}}{{$question->id}}" id="{{$manager->id}}{{$question->id}}" required>
                                    <option></option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                  ...
                  @elseif($question->unit == 'subop1')
                    ...
                    <input type="text" name="{{$question->id}}other" id="{{$question->id}}other"
                      placeholder="Enter (N/A) if not other">
                  ...
                  @else
                    <input type="text" name="{{$question->id}}" required id="{{$question->id}}" placeholder="{{$question->unit}}">
                  @endif
          ...
          @endforeach
          <div>
            <p style="font-weight: bold;" id="acknowledgeMsg">By clicking submit you acknowledge that you have reviewed
              you performance appraisal and understand the feedback provided.</p>
          </div>
