...
<li><a href="{{ url('cash_health/province/' . $province_id) }}"><i class="fa fa-circle-o"></i>Provincal Cash Health</a></li>
            ...
            @if(Sentinel::hasAccess('settings'))
               <li class="treeview @if(Request::is('executive_dashboard*')) active menu-open @endif">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Executive Dashboards</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
            ...
            <li class="treeview @if(Request::is('risk*') || Request::is('audits*')) active menu-open @endif">
                ...
                <ul class="treeview-menu">
                    ...
                    <li @if(Request::is('risk/blocked-list*')) class="active" @endif><a href="{{ route('risk.blocked-list') }}"><i class="fa fa-circle-o"></i> Blocked List (Deadlines)</a></li>
