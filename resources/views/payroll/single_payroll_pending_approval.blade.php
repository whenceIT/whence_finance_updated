...
@endsection
@section('content')
<form method="post" action="{{url('payroll/'.$id.'/approve_payroll')}}" class="form-horizontal" enctype="multipart/form-data">
{{csrf_field()}}
    <div class="form-group">
        <div class="col-md-3">
        <button type="submit" class="btn btn-success">Approve All!
        </button>
        </div>
                        ...
                        <td>
                            <div class="btn-group">
                               ...
                               Edit <i class="fa fa-pencil-square" aria-hidden="true"></i>
                                    ...
                                    <a type="button" class="btn"
                                                   href="{{url('payroll/'.$payroll->user_id.'/approve_single_payroll')}}" data-toggle="tooltip" title="{{trans_choice('general.view',1)}}">
                              Approve<i class="fa fa-pencil-square" aria-hidden="true"></i>
                                </a>
