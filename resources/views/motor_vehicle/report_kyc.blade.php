...
@section('title')KYC Executive Report@endsection
...
<style>
    ...
    .photo-thumb { height: 80px; width: 80px; object-fit: cover; border-radius: 6px; border: 1px solid #e2e8f0; }
...
<section class="content">
    ...
    <div class="no-print" style="margin-bottom: 16px;">
        ...
        <button onclick="window.print()" class="btn btn-primary btn-sm">
            <i class="fa fa-print"></i> Print KYC Report
        </button>
    </div>
    ...
    <div class="report-card" style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:24px; margin-bottom:24px;">
        <div class="report-header">
            <h2 class="report-title"><i class="fa fa-file-pdf-o"></i> KYC EXECUTIVE REPORT</h2>
