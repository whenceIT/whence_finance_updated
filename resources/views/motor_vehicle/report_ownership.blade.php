...
@section('title')Ownership Verification Report@endsection
...
<section class="content">
    ...
    <div class="no-print" style="margin-bottom: 16px;">
        ...
        <button onclick="window.print()" class="btn btn-primary btn-sm">
            <i class="fa fa-print"></i> Print Ownership Report
        </button>
    </div>
    ...
    <div class="report-card" style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:24px; margin-bottom:24px;">
        <div class="report-header">
            <h2 class="report-title"><i class="fa fa-file-contract"></i> OWNERSHIP VERIFICATION REPORT</h2>
