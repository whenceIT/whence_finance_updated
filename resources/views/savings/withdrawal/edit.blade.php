...
@section('title')
    {{ trans_choice('general.edit',1) }} {{ trans_choice('general.withdrawal',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        ...
        <form method="post" action="{{url('savings/withdrawal/'.$savings_transaction->id.'/update')}}" class="form-horizontal" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
