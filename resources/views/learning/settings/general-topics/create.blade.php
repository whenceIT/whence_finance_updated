...
@section('title', 'Add General Topic - Whence Learn')
...
<div class="page-header">
    <h1>Add General Topic</h1>
    <p>Create a new general topic</p>
</div>

<!-- Add General Topic Form -->
<div class="box box-primary" style="background: white; border-radius: 10px; box-shadow: var(--shadow); overflow: hidden;">
    <div class="box-header" style="padding: 20px; border-bottom: 1px solid var(--border-color);">
        <h3 class="box-title" style="font-size: 18px; font-weight: 600; color: var(--text-primary);">
            <i class="fa fa-plus-circle" style="color: var(--primary-color); margin-right: 10px;"></i>
            Topic Details
        </h3>
    </div>
    <div class="box-body" style="padding: 20px;">
         <form action="{{ route('learning.settings.general-topics.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
