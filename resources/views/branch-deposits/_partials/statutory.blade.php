...
$depositTypeId = 5; // or whatever deposit type you need
...
<div class="deposit-item deposit-card">
    ...
    <br>
    <button class="btn btn-primary complete-btn-3" style="min-width: 100px;" {{ $disabled ?? false ? 'disabled' : '' }}>
...
$(document).ready(function() {
    ...
    /* ---------- SAVE DEPOSIT BUTTON ---------- */
    $(document).on('click', '.complete-btn-3', function() {
        let $btn = $(this);
