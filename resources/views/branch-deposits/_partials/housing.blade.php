...
$depositTypeId = 2; // or whatever deposit type you need
...
<div class="deposit-item deposit-card">
    ...
    <br>
    <input type="number" class="form-control amount" placeholder="Enter amount to add" min="500" step="0.01" required {{ $disabled ?? false ? 'readonly' : '' }}>
    <br>
    <button class="btn btn-primary complete-btn-6" style="min-width: 100px;" {{ $disabled ?? false ? 'disabled' : '' }}>
...
$(document).ready(function() {
    ...
    /* ---------- SAVE DEPOSIT BUTTON ---------- */
    $(document).on('click', '.complete-btn-6', function() {
        let $btn = $(this);
