...
Route::group(['prefix' => 'learning', 'middleware' => 'sentinel'], function () {
    ...
    Route::get('/settings', [LearningSettingController::class, 'index'])->name('learning.settings');
      ...
      Route::get('/analytics/opened-materials', [App\Http\Controllers\LearningAnalyticsController::class, 'getOpenedMaterials'])->name('learning.analytics.opened-materials');
      Route::get('/analytics/average-duration-materials', [App\Http\Controllers\LearningAnalyticsController::class, 'getAverageDurationMaterials'])->name('learning.analytics.average-duration-materials');
      Route::get('/analytics/completed-materials', [App\Http\Controllers\LearningAnalyticsController::class, 'getCompletedMaterials'])->name('learning.analytics.completed-materials');
...
Route::group(['prefix' => 'cash_health'], function () {
    ...
    Route::get(
        'contribution/{id}',
        'CashHealthController@contributionHistory'
    )->name('cash_health.contribution');


    Route::get(
    'national/balances',
    'CashHealthController@nationalBalances'
)->name('cash_health.national.balances');


Route::get(
    'national/balance/{officeId}',
    'CashHealthController@nationalOfficeBalance'
)->name('cash_health.national.office.balance');
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('bmdashboard','UserController@bmdashboard');
...
Route::group(['prefix' => 'client'], function () {
    ...
    Route::get('transfer_approvals','ClientController@client_transfer_approvals');
    Route::get('{id}/approve_transfer','ClientController@approve_transfer');
    Route::get('{id}/delete_transfer','ClientController@delete_transfer');
...
Route::group(['prefix' => 'loan'], function () {
    ...
    Route::post('verify-password', 'LoanController@verifyPassword');
...
Route::group(['prefix' => 'payroll'], function () {
    ...
    Route::any('company_nhima','PayrollController@company_nhima');
    Route::any('company_paye','PayrollController@company_paye');
    Route::any('company_napsa','PayrollController@company_napsa');
    ...
    Route::get('export_nhima','PayrollController@company_nhima_excel');
    Route::get('export_paye','PayrollController@company_paye_excel');
    Route::get('export_napsa','PayrollController@company_napsa_excel');
